...
This uses the property of the delta function to "pick out"
the value of the function it is integrated with, at the point matching its spike (in this case $a$). 
...
![The steady state sequence of values producef by iteration of the logistic map $x_{n+1} = rx_n(1-x_n)$ for $r=3.2$](figs/log_seq_32.png){#fig-series}

![The power spectrum of the data produced by iteration of the logistic map with $r=3.2$](figs/log_pow_32.png){#fig-power}
...
![Sequence of values produced by iteration of the logistic map $x_{n+1} = rx_n(1-x_n)$ for $r=3.8$](figs/log_seq_38.png){#fig-series}

![The power spectrum of the data produced by iteration of the logistic map with $r=3.8$](figs/log_pow_38.png){#fig-power}
